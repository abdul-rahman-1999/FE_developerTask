...
function FeatureSection() {
  ...
  <Box sx={{padding:{xs:"40px 20px",sm:"60px"},borderBottom:"1px solid #F2F2F2"}}>
...
<Box
   ...
   <Box sx={{display:"flex",flexDirection:{xs:"column",sm:"row"},alignItems:"center",mt:{xs:"20px",sm:"40px"},justifyContent:"space-between",width:"90%",margin:"0px auto"}}>
    ...
    <Box sx={{width:{xs:"100%",sm:"29%"},textAlign:"center"}}>
 ...
 width: {xs:"48px",sm:"50x",md:"50px"}
    ...
    <Typography sx={{fontSize:{xs:"14px",sm:"16px"},fontWeight:600,color:"black",margin:"0px auto",textAlign:"center",fontFamily:"Inter",width:"90%",mt:"12px"}}>Share team inboxes</Typography>
    ...
    <Typography sx={{fontSize:{xs:"14px",sm:"16px"},fontWeight:600,color:"black",margin:"0px auto",textAlign:"center",fontFamily:"Inter",width:"90%",mt:"12px"}}>Deliver instant answers</Typography>
    ...
    <Typography sx={{fontSize:{xs:"14px",sm:"16px"},fontWeight:600,color:"black",margin:"0px auto",textAlign:"center",fontFamily:"Inter",width:"90%",mt:"12px"}}>Manage your team with reports</Typography>
